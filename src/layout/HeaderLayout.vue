...
<template>
  <section class="w-full drop-shadow-md z-50 xxs:fixed">
    <nav class="bg-white xl:p-2 xl:px-10 lg:px-6">
      <div class="xl:max-w-10xl mx-auto flex xl:justify-between xl:gap-32 lg:gap-24 md:gap-10 xxs:gap-4 items-center">
        <!-- Logo -->
        <div class="flex xl:gap-20 lg:gap-20 md:gap-10 justify-evenly xxs:w-24 xs:w-auto">
          <div class="flex justify-center items-center xxs:gap-6">
                ...
                <div class="flex flex-col p-0">
                  ...
                  <div class="hidden-nav-item text-sm primary-bg text-white">
                    ...
                    <router-link to="/account/notification"
                      class="block px-4 py-2 dark:hover:bg-gray-600 dark:hover:text-white">Account</router-link>
            ...
            <p class="text-black text-xl font-bold">
              <router-link style="color: black" class="text-black" to="/">RGS</router-link>
            </p>
          </div>
        ...
        <div class="flex w-full xl:gap-8 lg:gap-6 xxs:gap-3 md:justify-end justify-around xl:mx-10"
          ...
          <button v-show="isLoggedIn" class="text-gray-400 focus:outline-none">
            <svg width="20" height="20" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                stroke="black" stroke-width="2.22222" />
            </svg>
          </button>
          <button v-show="isLoggedIn" class="text-gray-400 focus:outline-none">
          ...
          <button v-show="isLoggedIn" class="text-black focus:outline-none">
            <router-link to="/services/register">
              <div class="flex justify-center items-center lg:gap-3">
                <span class="h-5 w-5"><svg width="20" height="20" viewBox="0 0 26 25" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <span class="text-sm sm:text-[12px] hidden md:flex">Register Business</span>
              </div>
            </router-link>
          </button>
          ...
          <div v-if="!isLoggedIn" class="xxs:hidden xs:flex xsxl:mx-5 font-semibold justify-center items-center">
          ...
          <button v-show="this.isLoggedIn" id="dropdownButton" @click="toggleLoggedInMenu"
            data-dropdown-toggle="dropdownMenu" class="flex text-sm md:me-0" type="button">
...
export default {
  ...
  methods: {
    ...
    handleInputWidthOnFocus(event) {
      event.target.classList.add('w-full');
    },
    handleInputWidthOnFocusOut(event) {

...
<template>
  <section class="lg:mx-14 md:mx-8 m-5 mb-10 p-5 rounded-lg bg">
    <section class="grid md:grid-cols-7 grid-cols-1 gap-4">
      ...
      <div class="md:col-span-3">
        <div>
          ...
          <div class="text-sm mt-2 font-bold text-black text-left">
            ...
            <p class="px-4 font-semibold my-2 text-xs md:text-sm"><span class="text-gray-400">CA State Class B General
                Building Contractor
                License</span></p>
    ...
    <section class="grid grid-cols-1 md:grid-cols-7 gap-4 my-3">

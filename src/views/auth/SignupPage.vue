<template>
        ...
        <div class="p-4 md:p-5 rounded-t">
          ...
          <div class="center w-full">
            ...
            <div v-if="!isPhone" class="relative w-4/5">
              <!-- Select Dropdown with Image Options -->
              <div
                class="absolute center h-full bg-gray-300 px-3 left-0 rounded-l-md border-gray-300 text-sm"
              >
                <div class="">
                  <svg
                    width="20"
              ...
              <input
                type="text"
                class="pl-16 w-full pr-3 border-gray-300 bg-white text-sm"
  ...
  <section
    class="w-full xxs:h-dvh overflow-hidden p-2 bg-default"
    :class="isModalActive ? 'blur-sm' : 'blur-none'"
  >
    <div class="xl:container lg:container md:container p-2 lg:p-5 mx-auto">
      <div class="grid p-3 gap-16 xl:grid-cols-9 lg:grid-cols-9 md:grid-cols-9">
        <div
          class="xl:col-span-5 xl:block lg:block lg:col-span-5 md:hidden sm:hidden xs:hidden xxs:hidden rounded-xl"
        >
          <div class="p-1">
            <div class="center">
        ...
        >
          ...
          <form class="">
            ...
            <div class="my-4">
              <DynamicInput
                :placeholder="'Ex. Ramman12'"
                :isLabel="true"
                :isTooltip="true"
                :isRequired="true"
                :tooltipContent="'tooltip string for username'"
            ...
            <div class="my-4 relative">
              <div
                class="absolute cursor-pointer top-0 right-10 color-primary text-blue-500 center gap-2"
              >
                <span class="inline"
                  ><svg
                    width="10"
                ...
                <span class="inline" @click="isPhone = !isPhone"
                  >{{ isPhone ? "Use Email" : "Use Phone" }}
                </span>
              </div>
              <DynamicInput
                v-if="!isPhone"
                :placeholder="'Ex.Ramman@gmail.com'"
                @change="verifyMailContact"
                :name="'email'"
                :isLabel="true"
                :isRequired="true"
                :isTooltip="true"
                :tooltipContent="'tooltip string email verify'"
                :label="'Enter Email'"
                :labelPosition="'top'"
              />
              <DynamicInput
                v-else
                :placeholder="'Ex.4477292003'"
                @change="verifyMailContact"
                :name="'contactNumber'"
                :isLabel="true"
                :isRequired="true"
                :isTooltip="true"
                :tooltipContent="'tooltip string contact number'"
            ...
            <div class="w-full my-2 text-start">
              <p class="text-gray-500 p-1 focus:outline-none">
                ...
                <span class="text-[#008080] inline-block">Terms of Use</span>
                <span class="text-[#008080] inline-block"></span>
              </p>
            </div>
          ...
          <div class="w-full my-5 text-center">
            <p class="text-gray-500 rounded-xl p-1 focus:outline-none">
              ...
              <router-link class="text-[#008080] inline-block" to="/signin"

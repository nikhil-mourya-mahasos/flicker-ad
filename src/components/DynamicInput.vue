<template>
  ...
  <div class="text-left">
    <label
      v-if="isLabel"
      :for="label"
      class="block font-semibold text-sm text-gray-900"
      >{{ label }}</label
    >
    <div class="mt-2">
      <div class="relative">
        ...
        >
          <div v-if="isPrefixIcon" class="w-10 center">
            ...
            >
              <path
                d="M25.5 2.5C25.5 1.125 24.375 0 23 0H3C1.625 0 0.5 1.125 0.5 2.5V17.5C0.5 18.875 1.625 20 3 20H23C24.375 20 25.5 18.875 25.5 17.5V2.5ZM23 2.5L13 8.75L3 2.5H23ZM23 17.5H3V5L13 11.25L23 5V17.5Z"
                fill="#232323"
                fill-opacity="0.3"
              />
            </svg>
        ...
        <div v-if="isValid == false" class="text-red-500">
          {{ name }}<span> is required.</span>
        </div>
      </div>
    </div>
  </div>

  ...
  >
    ...
    >
      ...
      <tab-content title="Post details">
        <div class="form-content">
          <h4 class="text-underline text-center mb-4 d-md-none">Post details</h4>
          <div class="fp-card fp-sm-no-card">
                ...
                <div class="fp-border-color-1 p-3 border round-12 mb-4">
                  <div class="row mx-n2">
                    <div class="col-md-6 px-2 mb-4">
                      <label>Accommodation Type <span class="text-danger">*</span></label>
                      <input
                        type="text"
                        class="form-control"
                    ...
                    <div class="col-md-6 px-2 mb-4">
                      ...
                      <div class="custom-control custom-checkbox mt-2">
                        ...
                        />
                        <label class="custom-control-label" for="available_from_today"
                      ...
                      <div class="pt-2">
                        <div class="d-inline-flex custom-control custom-radio">
                          <input
                            ...
                            value="Yes"
                          />
                          <label class="custom-control-label" for="smoking_allowed_yes"
                            >Yes</label
                          >
                        </div>
                        <div class="d-inline-flex ml-3 custom-control custom-radio">
                          <input
                            ...
                            value="No"
                          />
                          <label class="custom-control-label" for="smoking_allowed_no"
                            >No</label
                          >
                        </div>
                        <div class="d-inline-flex ml-3 custom-control custom-radio">
                      ...
                      <div class="pt-2">
                        <div class="d-inline-flex custom-control custom-radio">
                          <input
                            ...
                            value="Yes"
                          />
                          <label class="custom-control-label" for="pets_allowed_yes"
                            >Yes</label
                          >
                        </div>
                        <div class="d-inline-flex ml-3 custom-control custom-radio">
                          <input
                            ...
                            value="No"
                          />
                          <label class="custom-control-label" for="pets_allowed_no"
                            >No</label
                          >
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        >
                          <span
                            ...
                            v-for="(item, index) in formData.accommodation_properties"
                            :key="index"
                          >
                            {{ item }}
                            <fa
                    ...
                    <div class="col-md-6 px-2">
                      ...
                      <div class="">
                        ...
                        >
                          <span
                            class="information-item"
                            v-for="(item, index) in formData.accommodation_amenities"
                            :key="index"
                          >
                            {{ item }}
                            <fa
                  ...
                  <div class="row mx-n2">
                    ...
                    <div class="col-md-6 px-2">
                      ...
                      >
                        ...
                        <option value="After few months">After few months</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div class="fp-border-color-1 px-3 pt-3 border round-12 mb-4">
                  <div>
                    ...
                    <form class="add-benefit-form" @submit.prevent="addBenefit">
                      ...
                      />
                      <button type="submit" class="btn fp-btn-gradient ml-1">Add</button>
                    </form>
                  </div>
                </div>
                ...
                <div class="options">
                  <div class="custom-control custom-checkbox mb-3">
                    ...
                    <label class="custom-control-label" for="job_options_eoe"
                      >We are e-verified and Equal Opportunity Employer(EOE)</label
                    >
                  </div>
                  <div class="custom-control custom-checkbox mb-3">
                    <input
                ...
                <div class="row mx-n2">
                  ...
                  <div class="col-12 px-2 mb-4">
                    ...
                    <div>
                      <div class="d-inline-flex custom-control custom-checkbox mr-3">
                        ...
                        />
                        <label class="custom-control-label" for="training_modes_online"
                          >Online</label
                        >
                      </div>
                      <div class="d-inline-flex custom-control custom-checkbox mr-3">
                        ...
                        />
                        <label class="custom-control-label" for="training_modes_onsite"
                          >Onsite</label
                        >
                      </div>
                      <div class="d-inline-flex custom-control custom-checkbox mr-3">
                        ...
                        />
                        <label class="custom-control-label" for="training_modes_hybrid"
                          >Hybrid</label
                        >
                      </div>
                      <div class="d-inline-flex custom-control custom-checkbox">
                  ...
                  <div class="col-md-6 px-2 mb-4 mb-md-0">
                    ...
                    <p class="text-right text-muted mb-0">
                      {{ formData.training_fee ? formData.training_fee.length : 0 }}/ 500
                    </p>
                  </div>
                  <div class="col-md-6 px-2">
                      ...
                      <div>
                        <form class="d-flex" @submit.prevent="addProperty">
                          <input
                            ...
                            required
                          />
                          <button type="submit" class="btn fp-btn-gradient ml-2 no-wrap">
                            <fa icon="plus" />&nbsp;Add
                          </button>
                        </form>
                        <div
                        ...
                        <div class="row mx-n2">
                          ...
                          <div class="col-md-4 px-n2 mb-3 mb-md-0">
                            ...
                            <gmap-autocomplete
                              ...
                              @place_changed="updateBusinessAddress"
                              @input="formData.business_zipcode = $event.target.value"
                              placeholder="Zip"
                              style="max-width: 100%"
                              @keypress.enter="$event.preventDefault()"
                              :options="gmapAutocompleteOptions"
              ...
              <div v-else-if="selected_category.name === 'Rent/Lease'">
                <div class="row mx-n2">
                  ...
                  <div class="col-md-6 px-2 mb-4">
                    ...
                    <p class="text-right fp-text-color-main mb-0">
                      {{
                        formData.rent_lease_term ? formData.rent_lease_term.length : 0
                      }}/ 500
                    </p>
                  </div>
                </div>
              ...
              <div v-else>
                <div class="row mx-n2">
                      ...
                      <div>
                        <form class="d-flex" @submit.prevent="addService()">
                          <input
                            ...
                            required
                            :maxlength="
                              selected_category.name === 'Legal/Lawyers' ? 50 : 40
                            "
                          />
                          <button type="submit" class="btn fp-btn-gradient ml-2">
                            <fa icon="plus" /> Add
                  ...
                  <div class="col-md-6 px-2">
                    ...
                    <div class="form-group mb-0">
                      <label>
                        <span v-if="selected_category.name === 'Gigs/Freelancers'"
                          >Working Hours</span
                        >
            ...
            <div class="fp-card fp-sm-no-card">
              <div class="row mx-n2">
                <div class="col-lg-6 px-2 mb-4 mb-md-0">
                  <h6>
                    {{
                      streetRequired ? "Enter Property Location" : "Choose Post Location"
                    }}
                  </h6>
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="d-inline-flex custom-control custom-checkbox ml-auto">
                        <input
                          ...
                          @change="noReply"
                        />
                        <label class="custom-control-label" for="no_reply_to_this_post"
                ...
                <div class="col-12">
                  <div
                    ...
                    style="height: calc(100% - 85px); min-height: 300px; margin-top: 35px"
                  >
                    <GmapMap
                      ref="mapRef"
      ...
      <tab-content title="Submit" :selected="action === 'repost'">
        <div>
          ...
          <PostDetail :post="formData" v-if="step == 6" />
          <div class="mt-3 text-center">
            <div class="custom-control custom-checkbox">
              ...
              />
              <label class="custom-control-label fp-text-color-main" for="is_accepted"
                >I have read and accept the
                <a href="/learn/terms_of_use" class="fp-text-active" target="_blank"
                  >Terms of use</a
                >
                and
                <a href="/learn/privacy_policies" class="fp-text-active" target="_blank"
                  >Privacy policy</a
                ></label
              >
            </div>
...
export default {
  ...
  watch: {
    selected_category: function (newVal) {
      if (newVal) {
        ...
        if (["Real Estate", "Accommodation", "Rent/Lease"].includes(newVal.name)) {
    ...
    "formData.contact_phone_number": function (newVal) {
      this.formData.no_reply_to_this_post =
        newVal == "" && this.formData.contact_email == "" && !this.formData.enable_chat;
    },
  ...
  methods: {
    init() {
      ...
      if (location) {
        this.formData.location = Object.assign(
          ...Object.keys(this.formData.location).map((k) => ({ [k]: location[k] }))
        );
    ...
    selectCategory(item) {
      if (this.selected_category && item && this.selected_category.id == item.id) {
    ...
    updateAddress(place) {
      this.map_center.lat = this.formData.location.latitude = place.geometry[
        "location"
      ].lat();
      this.map_center.lng = this.formData.location.longitude = place.geometry[
        "location"
      ].lng();
      ...
      for (var i = 0; i < place.address_components.length; i++) {
        for (var j = 0; j < place.address_components[i].types.length; j++) {
          if (place.address_components[i].types[j] === "postal_code") {
            this.formData.location.zipcode = place.address_components[i].long_name;
            this.formData.zipcode = place.address_components[i].long_name;
          }
          if (place.address_components[i].types[j] === "administrative_area_level_1") {
            this.formData.location.state = place.address_components[i].short_name;
          ...
          if (place.address_components[i].types[j] === "country") {
            this.formData.location.country = place.address_components[i].short_name;
          }
        }
      }
    ...
    updateBusinessAddress(place) {
      this.map_center.lat = this.formData.business_location.latitude = place.geometry[
        "location"
      ].lat();
      this.map_center.lng = this.formData.business_location.longitude = place.geometry[
        "location"
      ].lng();
      for (var i = 0; i < place.address_components.length; i++) {
        for (var j = 0; j < place.address_components[i].types.length; j++) {
          if (place.address_components[i].types[j] === "postal_code") {
            ...
            this.formData.business_zipcode = place.address_components[i].long_name;
          }
          if (place.address_components[i].types[j] === "administrative_area_level_1") {
            this.formData.business_location.state =
              place.address_components[i].short_name;
            this.formData.business_state = place.address_components[i].short_name;
          }
          if (place.address_components[i].types[j] === "administrative_area_level_2") {
            let county = place.address_components[i].short_name;
            county = county.replace(" County", "");
          ...
          if (place.address_components[i].types[j] === "locality") {
            this.formData.business_location.city = place.address_components[i].long_name;
